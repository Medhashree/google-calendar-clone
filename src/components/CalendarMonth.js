...
//         key={day}
//         className={`p-1 ${
//           !isSameMonth(day, monthStart) ? 'bg-gray-900' : ''
//         }`}
//       >
//         <DayCell day={day} />
//       </div>
...
//     rows.push(
//       <div key={i} className="grid grid-cols-7 gap-2 flex-1">
//         {days.slice(i, i + 7)}
//       </div>
//     );
//   }
...
//   return (
//     <div className="p-4 rounded-xl shadow-lg bg-black border border-gray-800 h-full flex flex-col">
//       <div className="grid grid-cols-7 text-center text-xs font-semibold text-gray-400 mb-2">
//         {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((d) => (
//           <div key={d}>{d}</div>
//         ))}
//       </div>
//       <div className="flex flex-col gap-2 flex-1">{rows}</div>
//     </div>
//   );
// };
